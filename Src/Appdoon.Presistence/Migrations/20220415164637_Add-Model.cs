    ...
    public partial class AddModel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2022, 4, 15, 21, 16, 37, 598, DateTimeKind.Local).AddTicks(3781), false, "Admin", null, null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 2, new DateTime(2022, 4, 15, 21, 16, 37, 600, DateTimeKind.Local).AddTicks(8614), false, "Teacher", null, null });

            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id", "InsertTime", "IsRemoved", "Name", "RemoveTime", "UpdateTime" },
                values: new object[] { 3, new DateTime(2022, 4, 15, 21, 16, 37, 600, DateTimeKind.Local).AddTicks(8721), false, "User", null, null });
